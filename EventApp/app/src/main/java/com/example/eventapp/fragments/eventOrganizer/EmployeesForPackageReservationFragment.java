...
import com.example.eventapp.databinding.FragmentEmployeesForPackageReservationBinding;
...
public class EmployeesForPackageReservationFragment extends DialogFragment {
    ...
    private FragmentEmployeesForPackageReservationBinding binding;
    ...
    public EmployeesForPackageReservationFragment() {
        // Required empty public constructor
    }

    public static EmployeesForPackageReservationFragment newInstance(Service serviceToSend, Event eventToSend, String pack, PackageDetailsFragment fragmentToSend) {
        EmployeesForPackageReservationFragment fragment = new EmployeesForPackageReservationFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            selectedEvent = getArguments().getParcelable("EVENT_ID_RES");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentEmployeesForPackageReservationBinding.inflate(inflater, container, false);
                ...
                if (workingTimes != null) {
                    ...
                    if(employeeWorkingTime!=null)
                    {
                        ...
                        if(isEmployeeWorking()) {   //da li je event date u radnom vremenu zaposlenog
                            ...
                            PackageCalendarFragment dialog1 = PackageCalendarFragment.newInstance(service, selectedEvent, selectedEmployee, startTimeStr, endTimeStr, packageId, packageDetailsFragment);
                            dialog1.show(fragmentManager, "PackageCalendarFragment");
                            //dialog.dismiss();
