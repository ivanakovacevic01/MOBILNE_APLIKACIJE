...
import com.example.eventapp.adapters.PackageCalendarSlotsListAdapter;
...
import com.example.eventapp.databinding.FragmentPackageCalendarBinding;
...
public class PackageCalendarFragment extends  DialogFragment {
    ...
    private FragmentPackageCalendarBinding binding;
    public PackageCalendarFragment() {
        // Required empty public constructor
    }

    public static PackageCalendarFragment newInstance(Service serviceToSend, Event eventToSend, Employee employeeToSend, String startTime, String endTime, String pack, PackageDetailsFragment fragmentToSend) {
        PackageCalendarFragment fragment = new PackageCalendarFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentPackageCalendarBinding.inflate(inflater, container, false);
                    ...
                    public void onServiceFetch(ArrayList<Service> services) {
                        ...
                        weeklyEventRepo.getAll(new WeeklyEventRepo.WeeklyEventFetchCallback() {
                            ...
                            public void onWeeklyEventFetch(ArrayList<WeeklyEvent> events) {
                                ...
                                PackageCalendarSlotsListAdapter adapter = new PackageCalendarSlotsListAdapter(getActivity(), slots, service, event, employee, packageId, packageDetailsFragment);
